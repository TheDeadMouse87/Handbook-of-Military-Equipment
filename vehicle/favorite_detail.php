...
// Определяем страницу для кнопки "Назад" - всегда ведем на account.php
...
if ($can_edit_article && $_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_fighter'])) {
    ...
    header("Location: favorite_detail.php?id=" . $fighter_id);
    exit();
}
...
<head>
    ...
    <title><?php echo htmlspecialchars($fighter['Name'], ENT_QUOTES, 'UTF-8'); ?> - Избранное - Военный справочник</title>
...
<body>
    <div class="top-bar">
        <nav class="nav-menu">
            ...
            <div class="nav-item">
                <a href="<?php echo $back_url; ?>" class="nav-link">Назад в личный кабинет</a>
            </div>
        </nav>
    ...
    <div class="main-content">
        <div class="vehicle-detail">
            ...
            <div class="action-buttons">
                <a href="<?php echo $back_url; ?>" class="back-button">← Назад в личный кабинет</a>
